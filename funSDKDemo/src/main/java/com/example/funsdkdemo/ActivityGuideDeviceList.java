 ...
 *
 */
public class ActivityGuideDeviceList extends ActivityDemo implements OnClickListener, OnFunDeviceListener, OnFunDeviceItemClickListener, OnFunDeviceOptListener {
...
//		}
	...
	public void onFunDeviceRenameClicked(final FunDevice funDevice) {
        ...
        AlertDialog alert = builder.setTitle(R.string.device_opt_change_name)
                .setMessage(R.string.device_opt_change_name_tip)
                .setView(textEntryView)
                .setNegativeButton(R.string.common_cancel, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                    	//Toast.makeText(ActivityGuideDeviceList.this, "取消保存", Toast.LENGTH_SHORT).show();
                    }
                })
